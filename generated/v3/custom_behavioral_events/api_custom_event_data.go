...
type ApiCustomSendSendRequest struct {
	ctx                                  context.Context
	ApiService                           *CustomEventDataAPIService
...
func (r ApiCustomSendSendRequest) Execute() (*http.Response, error) {
...
func (a *CustomEventDataAPIService) SendSend(ctx context.Context) ApiCustomSendSendRequest {
	return ApiCustomSendSendRequest{
		ApiService: a,
		ctx:        ctx,
	}
}
...
func (a *CustomEventDataAPIService) SendSendExecute(r ApiCustomSendSendRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomEventDataAPIService.SendSend")
	if err != nil {
