...
func (r ApiPostCrmV3ObjectsCompaniesGdprDeletePurgeRequest) PublicGdprDeleteInput(publicGdprDeleteInput PublicGdprDeleteInput) ApiPostCrmV3ObjectsCompaniesGdprDeletePurgeRequest {
	r.publicGdprDeleteInput = &publicGdprDeleteInput
	return r
}

func (r ApiPostCrmV3ObjectsCompaniesGdprDeletePurgeRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostCrmV3ObjectsCompaniesGdprDeletePurgeExecute(r)
}

/*
PostCrmV3ObjectsCompaniesGdprDeletePurge GDPR DELETE
...
func (a *GDPRAPIService) PostCrmV3ObjectsCompaniesGdprDeletePurgeExecute(r ApiPostCrmV3ObjectsCompaniesGdprDeletePurgeRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/crm/v3/objects/companies/gdpr-delete"
