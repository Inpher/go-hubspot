...
/*
AssociationsArchive Remove an association between two companies
...
*/
func (a *AssociationsApiService) AssociationsArchive(ctx context.Context, companyId string, toObjectType string, toObjectId string, associationType string) ApiAssociationsArchiveRequest {
	return ApiAssociationsArchiveRequest{
		ApiService:      a,
		ctx:             ctx,
		companyId:       companyId,
...
/*
AssociationsCreate Associate a company with another object
...
*/
func (a *AssociationsApiService) AssociationsCreate(ctx context.Context, companyId string, toObjectType string, toObjectId string, associationType string) ApiAssociationsCreateRequest {
	return ApiAssociationsCreateRequest{
		ApiService:      a,
		ctx:             ctx,
		companyId:       companyId,
...
/*
AssociationsGetAll List associations of a company by type
...
*/
func (a *AssociationsApiService) AssociationsGetAll(ctx context.Context, companyId string, toObjectType string) ApiAssociationsGetAllRequest {
	return ApiAssociationsGetAllRequest{
		ApiService:   a,
		ctx:          ctx,
		companyId:    companyId,
