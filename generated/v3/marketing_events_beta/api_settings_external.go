...
type ApiSettingsExternalCreateRequest struct {
	ctx                    context.Context
...
func (r ApiSettingsExternalCreateRequest) EventDetailSettingsUrl(eventDetailSettingsUrl EventDetailSettingsUrl) ApiSettingsExternalCreateRequest {
	r.eventDetailSettingsUrl = &eventDetailSettingsUrl
	return r
}

func (r ApiSettingsExternalCreateRequest) Execute() (*EventDetailSettings, *http.Response, error) {
...
*/
func (a *SettingsExternalApiService) SettingsCreate(ctx context.Context, appId int32) ApiSettingsExternalCreateRequest {
	return ApiSettingsExternalCreateRequest{
		ApiService: a,
		ctx:        ctx,
		appId:      appId,
	}
...
func (a *SettingsExternalApiService) SettingsCreateExecute(r ApiSettingsExternalCreateRequest) (*EventDetailSettings, *http.Response, error) {
	var (
...
type ApiSettingsExternalGetAllRequest struct {
	ctx        context.Context
	ApiService *SettingsExternalApiService
	appId      int32
}

func (r ApiSettingsExternalGetAllRequest) Execute() (*EventDetailSettings, *http.Response, error) {
...
*/
func (a *SettingsExternalApiService) SettingsGetAll(ctx context.Context, appId int32) ApiSettingsExternalGetAllRequest {
	return ApiSettingsExternalGetAllRequest{
		ApiService: a,
		ctx:        ctx,
		appId:      appId,
	}
...
//
//	@return EventDetailSettings
func (a *SettingsExternalApiService) SettingsGetAllExecute(r ApiSettingsExternalGetAllRequest) (*EventDetailSettings, *http.Response, error) {
	var (
