...
------------- | ------------- | -------------
[**BatchArchive**](BatchAPI.md#BatchArchive) | **Post** /crm/v3/objects/products/batch/archive | Archive a batch of products by ID
[**BatchCreate**](BatchAPI.md#BatchCreate) | **Post** /crm/v3/objects/products/batch/create | Create a batch of products
[**BatchRead**](BatchAPI.md#BatchRead) | **Post** /crm/v3/objects/products/batch/read | Read a batch of products by internal ID, or unique property values
[**BatchUpdate**](BatchAPI.md#BatchUpdate) | **Post** /crm/v3/objects/products/batch/update | Update a batch of products
...
func main() {
	batchInputSimplePublicObjectInputForCreate := *openapiclient.NewBatchInputSimplePublicObjectInputForCreate([]openapiclient.SimplePublicObjectInputForCreate{*openapiclient.NewSimplePublicObjectInputForCreate()}) // BatchInputSimplePublicObjectInputForCreate | 
...
func main() {
	batchInputSimplePublicObjectBatchInput := *openapiclient.NewBatchInputSimplePublicObjectBatchInput([]openapiclient.SimplePublicObjectBatchInput{*openapiclient.NewSimplePublicObjectBatchInput()}) // BatchInputSimplePublicObjectBatchInput | 
