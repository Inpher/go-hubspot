...
```go
auth := context.WithValue(context.Background(), products.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, products.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
